...
As per the project requirement, the dataset produced by the run_analysis.R script includes the columns from the original dataset corresponding to measurements on the mean and standard deviation of each measurement. The original column names have been applied a cleaning process, for instance, certain characters have been removed or replaced with underscore, and the abbreviations contained in the column names have been expanded to full words.
